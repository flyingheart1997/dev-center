...
function GoogleSvgIcon({ className = "h-4 w-4" }: { className?: string }) {
  return (
...
function GitHubSvgIcon({ className = "h-4 w-4" }: { className?: string }) {
  return (
...
function LinkedInSvgIcon({ className = "h-4 w-4" }: { className?: string }) {
  return (
